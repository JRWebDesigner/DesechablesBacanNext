...
export default function Feiteng(){
    return(
      <>
				<h1 data-aos='fade-up' className="text-center font-bold text-3xl mt-20">Feiteng</h1>
        <div className="flex flex-wrap justify-around items-center gap-5 m-10">
				{
        products.filter(prod=>prod.mark.toUpperCase()==='FEITENG').length== 0 ? (
          <div className='flex justify-center items-center text-2xl'>Se nos acabo los Productos de la marca Feiteng</div>
        ):(products
      .filter((prod) => prod.mark.toUpperCase() === 'FEITENG')
      .map((prod) => (
        <div 
          key={prod.id} 
