    ...
    return(
        ...
        <div className="flex justify-around items-center flex-wrap gap-10 w-full">
            ...
            <div>
                ...
                <ul>
                    <li>
                       <a href="https://maps.app.goo.gl/yFAEZmBMMVkLzP8cA"><strong>Dirección: </strong> Calle 4 Villa Dolores, <br /> El Alto, Bolivia</a>
                    </li>
                    <li>
                        <a href="https://wa.link/t7lgw0">
            ...
            <span className="text-center uppercase grid place-items-center gap-5">
               ...
               <div className="flex items-center gap-3">
                ...
                <a href="https://www.instagram.com/desechables_bacan/profilecard/?igsh=MXY4emM4bWRjNWs3Yg==">
